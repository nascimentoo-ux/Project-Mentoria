...
| --- | --- | --- |
| `assets/elite40-shield.png` | Escudo "Metodologia Elite40+" | header, legenda da foto, fallback do encerramento, rodapé |
| `assets/logo-reveal.webm` | Reveal vertical da logo (fundo transparente) | seção de encerramento |
